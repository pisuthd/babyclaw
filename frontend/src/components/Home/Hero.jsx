        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-center">
          ...
          <div className="order-2 lg:order-1 text-center lg:text-left col-span-3">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 bg-gradient-to-r from-accent-cyan to-text-primary bg-clip-text text-transparent">
              Celo's First On-chain Bank<br />Powered by BABY
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-8 md:mb-12">
              <button
                ...
                className="px-8 py-3 bg-accent-cyan text-bg-primary font-semibold rounded-full transition-all hover:bg-accent-cyan-hover hover:-translate-y-0.5 hover:shadow-[0_6px_30px_rgba(62,223,223,0.4)] border-2 border-accent-cyan hover:border-accent-cyan-hover"
              >
                Enter the Lounge
              </button>
              <button
                onClick={() => onNavigate('/markets')}
                className="px-8 py-3 bg-transparent text-accent-cyan font-semibold rounded-full transition-all hover:bg-accent-cyan/10 border-2 border-accent-cyan hover:border-accent-cyan-hover"
              >
                View Markets
              </button>
            </div>
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-4 text-xs md:text-sm text-text-secondary font-space">
              <span className="flex items-center gap-2">
                ...
                Built on Compound V2 fork
              </span>
              <span className="flex items-center gap-2">
                <span className="w-1.5 h-1.5 bg-accent-cyan rounded-full"></span>
                ERC-8004 & x402 enabled
              </span>
              <span className="flex items-center gap-2">
                <span className="w-1.5 h-1.5 bg-accent-cyan rounded-full animate-blink"></span>
