  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-8 py-12">
      <div className="text-center">
        ...
        <p className="text-lg text-text-secondary mb-8">Your exclusive space for staking rewards and more</p>
        ...
        <div className="mt-16 p-8 rounded-2xl border border-border-color bg-bg-secondary/50 backdrop-blur-sm">
          <div className="animate-pulse">
            ...
            <p className="text-text-secondary">
              The Baby Lounge is under construction. Stay tuned for staking rewards, exclusive features, and more!
            </p>
          </div>
        </div>
      </div>
