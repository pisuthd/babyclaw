  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-8 py-12">
      <div className="text-center">
        ...
        <p className="text-lg text-text-secondary mb-8">Explore lending and borrowing markets</p>
        ...
        <div className="mt-16 p-8 rounded-2xl border border-border-color bg-bg-secondary/50 backdrop-blur-sm">
          <div className="animate-pulse">
            ...
            <p className="text-text-secondary">
              Browse and interact with various lending markets. Supply assets to earn interest or borrow against your collateral.
            </p>
          </div>
        </div>
      </div>
